    ...
    <section class="section dashboard">
        <div class="row">
            <div class="card text-center">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Tambah Daftar Haji</h5>
                                ...
                                <form id="pengalaman_kerja_form" method="POST"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="tahun_keluar">Tahun Berangkat</label>
                ...
                <h5 class="card-title">Daftar Haji</h5>
                        ...
                        <tbody>
                            ...
                            <div class="modal fade" id="editModal-{{ $pk->id }}" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Edit Daftar Haji</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
